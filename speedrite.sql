...
CREATE TABLE `main` (
  ...
  `phone` varchar(50) NOT NULL COMMENT 'Store values in the E.164 format: https://en.wikipedia.org/?title=E.164 ,handle extensions via RFC3966 which appends ";ext=1234"',
